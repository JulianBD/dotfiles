;; Vendored from mattwparas/helix-config (cogs/git-status-picker.scm), commit a101da0.
;; Not tracked with upstream -- copied as a starting point, adapt freely.
;; No LICENSE file upstream; kept for personal use with attribution.
